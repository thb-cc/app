...
You need to have an AWS Account with a S3 bucket and DynamoDB table. Copy both names into the `application.yaml` file. 
...
Start the application by running AppApplication. A local Server starts and is available at http://localhost:8443/.
